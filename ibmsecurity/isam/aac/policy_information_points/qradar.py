...
def update(isamAppliance, name, properties, attributes=None, description=None,
           type="QRadar User Behavior Analytics", new_name=None, check_mode=False, force=False):
    """
...
def set(isamAppliance, name, properties, attributes=None, description=None, type="QRadar User Behavior Analytics",
