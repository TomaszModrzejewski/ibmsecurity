...
def add(isamAppliance, name, properties, attributes, description=None, type="RESTful Web Service",
    ...
    """
    Create a RESTful Web Service policy information point
    """
...
def set(isamAppliance, name, properties, attributes, description=None, type="RESTful Web Service", new_name=None,
        check_mode=False, force=False):
    """
    Creating or Modifying a RESTful Web Service
    """
    ret_obj = search(isamAppliance, name=name)
    id = ret_obj['data']
