...
def add(isamAppliance, name, properties, attributes, description=None, type="Database", check_mode=False,
        force=False):
    """
    Create a Database policy information point
    """
...
def set(isamAppliance, name, properties, attributes, description=None, type="Database", new_name=None, check_mode=False,
        force=False):
    """
